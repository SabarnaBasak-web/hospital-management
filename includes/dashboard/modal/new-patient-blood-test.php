                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="mb-3">
                                ...
                                <input readonly type="number" name="price" class="form-control" id="price" placeholder="1500" required />
                            </div>
                        </div>
                    </div>
                    <!-- Row 3 -->
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="amountPaid" class="form-control" id="amountPaid" placeholder="1500" required />
                            </div>
                        </div>
                        <div class="col">
                            <!-- Due Amount -->
                            <div class="mb-3">
                                ...
                                <input readonly name="dueAmount" class="form-control" id="dueAmount" placeholder="1001" required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="discount" class="form-control" id="discount" placeholder="25" required disabled />
                            </div>
                        </div>
                        <div class="col">
                            <!-- Status -->
